...
class ScanResult(Base):
    ...
    cipher = Column(
        String)  # "ECDHE-RSA-AES128-GCM-SHA256 TLScustomer_id = db.Column(db.Integer, db.ForeignKey('customers.id'))
...
class CertificateChain(Base):
    ...
    subject = Column(
        String)  # "subject": "CN=e-sett.ffrontier.com; OU=Mizuho Financial Group 1; O=Mizuho Bank, Ltd.; L=CHIYODA-KU; ST=Tokyo; C=JP; serialNumber=010001008845; jurisdictionC=JP; businessCategory=Private Organization",
    issuer = Column(
        String)  # "issuer": "CN=DigiCert SHA2 Extended Validation Server CA; OU=www.digicert.com; O=DigiCert Inc; C=US",
    ...
    subjectKeyIdentifier = Column(
        String)  # "subjectKeyIdentifier": "F2:3C:C5:53:CD:E6:74:2D:FA:8D:A3:BF:53:47:04:0B:D2:FB:71:50",
